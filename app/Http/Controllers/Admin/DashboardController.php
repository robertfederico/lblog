...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $new_authors = User::where('role_id', 2)
        ...
        return view('admin.dashboard', compact('posts', 'popular_posts', 'total_pending_posts', 'all_views', 'author_count', 'new_authors', 'active_authors', 'category_count', 'tag_count'));
    }
}