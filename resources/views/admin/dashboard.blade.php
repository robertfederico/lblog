        ...
        <div class="row clearfix">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="info-box bg-black hover-zoom-effect">
                    ...
                    <div class="content">
                        <div class="text">NEW AUTHORS</div>
                        <div
                            class="number count-to"
                            data-from="0"
                            data-to="{{ $new_authors }}"
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ str_limit($popular_post->title, 30)  }}</td>
                                    ...
                                    @endif  
                                    <td>
                                        <a target="blank" class="btn btn-sm btn-primary waves-effect" href="{{ route('post.details',$popular_post->slug) }}">
                                            View
                                        </a>
                                    </td>
                                </tr> 
                            ...
                            <table class="table table-hover dashboard-task-infos">
                                ...
                                @foreach($active_authors as $key => $author)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('author.profile', $author->username) }}" target="blank" class="btn btn-sm btn-warning waves-effect">
                                                View 
                                            </a>
                                        </td>
                                    </tr>
