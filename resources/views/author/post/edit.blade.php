...
<section class="content">
    <div class="container-fluid">
        <form id="form_validation" method="POST" action="{{ route('author.post.update', $post->id) }}"
            ...
            <div class="row clearfix">
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2 class="text-uppercase"> Edit Post</h2>
                        </div>
                        <div class="body">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2 class="text-uppercase">Update Categories and Tags</h2>
                        </div>
                        <div class="body">
